...
void   entry_t__data_t__init
                     (EntryT__DataT         *message)
{
  static const EntryT__DataT init_value = ENTRY_T__DATA_T__INIT;
  *message = init_value;
}
void   entry_t__init
                     (EntryT         *message)
...
static const ProtobufCFieldDescriptor entry_t__data_t__field_descriptors[2] =
{
  {
    "datasize",
    1,
    ...
    PROTOBUF_C_TYPE_INT32,
    0,   /* quantifier_offset */
    offsetof(EntryT__DataT, datasize),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned entry_t__data_t__field_indices_by_name[] = {
  1,   /* field[1] = data */
  0,   /* field[0] = datasize */
};
static const ProtobufCIntRange entry_t__data_t__number_ranges[1 + 1] =
{
  { 1, 0 },
  { 0, 2 }
};
const ProtobufCMessageDescriptor entry_t__data_t__descriptor =
{
  PROTOBUF_C__MESSAGE_DESCRIPTOR_MAGIC,
  "entry_t.data_t",
  "DataT",
  "EntryT__DataT",
  "",
  sizeof(EntryT__DataT),
  2,
  entry_t__data_t__field_descriptors,
  entry_t__data_t__field_indices_by_name,
  1,  entry_t__data_t__number_ranges,
  (ProtobufCMessageInit) entry_t__data_t__init,
  NULL,NULL,NULL    /* reserved[123] */
};
