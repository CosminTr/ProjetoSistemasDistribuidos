...
typedef struct _EntryT__DataT EntryT__DataT;
...
#define ENTRY_T__DATA_T__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&entry_t__data_t__descriptor) \
...
typedef void (*MessageT_Closure)
                 (const MessageT *message,
                  void *closure_data);
typedef void (*EntryT__DataT_Closure)
                 (const EntryT__DataT *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor entry_t__data_t__descriptor;
